...
//         let sNo = 1
//         let cvStaticArry = [];
//         covanantsData.patnership.map((cv) => {
...
//                 }
//             }
//             pdfDocs.fontSize(13).text('\nఈ క్రింది సాక్షుల సమక్షంలో పైన పేర్కొనిన తేదీన ఈ పార్టనర్షిప్ దస్తావేజు పై  సంతకములు చేయడమైనది.\n',{align:'justify',lineGap:0})
