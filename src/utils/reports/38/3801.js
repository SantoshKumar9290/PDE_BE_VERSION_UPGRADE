...
//                     })
//                     pdeStyle.content.push({
//                         text:'(Hereinafter called the “INDEMNIFIER” which expression shall wherever it occurs in this deed include her heirs, executors, assignees and administrators).',style:["p1Text"]
//                     })
//                 } else {
//                     pdeStyle.content.push({
...
//                     });
//                     pdeStyle.content.push({
//                         text:'(Hereinafter called the “INDEMNIFIED”  which expression shall wherever it occurs in this deed includes his heirs, executors, assignees and administrators).',style:["p1Text"]
//                     })
//                 } else {
//                     pdeStyle.content.push({
//                         text: `M/s .${name}, ${address} is represented by`, style: ["p1Text"]
...
//         let sNo = 1
//         let cvStaticArry = [];
//         covanantsData.Indemnity.map((cv) => {
...
//         pdeStyle.content.push({text:'\n IN WITNESS WHEREOF the Indemnifier herein has set his/their/its hands and seal on the date, month and year above first written.\n ',style:['p1Text']})
...
//                 pdfDocs.fontSize(13).text('\n(అనువారు, వారి వారసులు, స్తానీయులు, రెప్రెసెంటేటివ్ లు, ఏజెంట్లు మరియు అసైనీలు “ఇండెమ్నిఫైయర్  “ గా ఈ దస్తావేజునందు పరిగణించబడుదురు).',{align:'justify',lineGap:0});
//                 pdfDocs.moveDown();
//                 }
//             }else{
...
//                 pdfDocs.fontSize('13').text('\n (అనువారు, వారి వారసులు, స్తానీయులు, రెప్రెసెంటేటివ్ లు, ఏజెంట్లు మరియు అసైనీలు “ఇండెమ్నిఫైడ్”  గా ఈ దస్తావేజునందు పరిగణించబడుదురు).',{align:'justify',lineGap:0})
//                 pdfDocs.moveDown();
//                 }
//             }else{
//                 pdfDocs.fontSize('13').text(`శ్రీ/శ్రీమతి. .......,S/O. .........,వయస్సు ........ సంవత్సరాలు,ప్రస్తుతం......... లో నివాసము`,{align:'justify',lineGap:0});
...
//                 }
//             }
//             pdfDocs.fontSize(13).text('\n ఈ క్రింది సాక్షుల సమక్షంలో పైన పేర్కొనిన తేదీన ఈ ఇండెమ్నిటి బాండుపై ఇండెమ్నిఫైయర్  సంతకములు చేయదమైనది.\n',{align:'justify',lineGap:0})
...
//             //     pdfDocs.moveDown();
//             // }
//             pdfDocs.fontSize('13').text(`\n\n హామీదారు`,{align:'left',lineGap:0});

//             pdfDocs.fontSize('13').text(`సాక్షులు`,{align:'left',lineGap:0,underline:true});
//             pdfDocs.fontSize('13').text(`\n 1.                   `,{align:'left',lineGap:0});
//             pdfDocs.fontSize('13').text(`\n 2.                   `,{align:'left',lineGap:0});
//             pdfDocs.end();
...
const telGenarateDocs = async (data, path) => {
  try {
    let teluguHtmlFilePath = Path.join(__dirname, `../htmlFiles/38/telugu.hbs`);
