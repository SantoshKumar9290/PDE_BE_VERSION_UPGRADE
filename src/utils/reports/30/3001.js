...
//        // var mm = new Date(`${yyyy}-${m}-${dd}`).toLocaleDateString('en-GB')
//         pdeStyle.content =[];
...
//         pdeStyle.content.push({text:`This ${subDesc.toUpperCase()} is made and executed on ${data.executionDate}, by :`, style:['p1sideHeaders']});
...
//                     })
//                     pdeStyle.content.push({
//                         text:`\n(Hereinafter referred to as the NATURAL PARENTS/FIRST PARTY)`
//                     })
...
//                     });
//                     pdeStyle.content.push({
//                         text:`\n (Hereinafter referred to as the ADOPTIVE PARENTS/SECOND PARTY)`
//                      });
//                 }else{
//                     pdeStyle.content.push({
//                         text:`M/s .${name}, ${address} is represented by`,style:["p1Text"]
...
//         }
//         pdeStyle.content.push({
//             text:'The PARTIES desired to execute a Deed of Adoption, so as to have an authentic record of the adoption having taken place.',
//             style:["p1Text"]
//         });

//         if(TRAN_DESC){

//             pdeStyle.content.push({text:`\n NOW THIS DEED OF ADOPTION WITNESSETH AS FOLLOWS :`,style:['sideHeaderNames']})
//             let sNo =1
//             let cvStaticArry =[];
//             covanantsData.Adoption.map((cv)=>{
...
//         }
//         pdeStyle.content.push({
//             text:'\n IN WITNESS WHEREOF the both the parties hereto signed this deed on the day and the year first above written.',
//             style:["p1Text"]
//         })

//         pdeStyle.content.push({text:`\n NATURAL PARENTS	 :`,style:['p1last_MRleft']})
//         if(data?.executent && data?.executent.length >0){
//             let exNo =1
...
//             }
//         }
//         pdeStyle.content.push({text:`\n ADOPTIVE PARENTS :`,style:['p1last_MRleft']})
//         if(data?.claimant && data?.claimant.length >0){
//             let exNo =1
...
//                 pdfDocs.moveDown();
//                 pdfDocs.fontSize('13').text('(దత్తత ఇస్తున్న తల్లి దండ్రులు)  1వపార్టీ గాను,',{align:'justify',lineGap:0});
//                 }
//             }else{
...
//                 pdfDocs.moveDown();
//             }
//             pdfDocs.fontSize('13').text(`(దత్తత తీసుకుంటున్న తల్లి దండ్రులు))  2వపార్టీ గాను ఇరు పార్టీలవారు ఏకస్తులై  వ్రాయించుకొన్న దత్తత స్వీకార దస్తావేజు .`,{align:'justify',lineGap:0})
...
//                 }
//             }
//             pdfDocs.fontSize('13').text(`\n\nదత్తతకు దారితీసిన పరిస్థితులు, దత్తత క్రతువు జరిగిన విధానం `,{align:'justify',lineGap:1});

//             pdfDocs.fontSize('13').text(`\n\nపై విధంగా దత్తత స్వీకరణ జరిగినప్పటికి ఎటువంటి వ్రాతపూర్వక దస్తావేజులు యిప్పటివరకు వ్రాసుకోనందున మన యిరు పార్టీలవరము ఈ దత్తత స్వీకరపత్రం వ్రాయించుకోవదమైనది . `,{align:'justify',lineGap:1});
//             pdfDocs.fontSize(13).text('\n\nప్రస్తుతం ఈ దత్తత స్వీకరణ దస్తావేజు ఈ క్రింది విషయాలకు ద్రువీకరించుచున్నది దత్తత విధి విధానాలు',{align:'justify',lineGap:0})
...
//                 }
//             }
//             pdfDocs.fontSize(13).text('\n\nఈ దస్తావేజు దాఖలా విషయములు ఇందలి ఇరు పార్టీల పూర్తిసమ్మతితో ఒప్పుకున్నవే గాని సదరు విషయముల యందు ఎవ్వరి ప్రోధ్భలము గాని బలవంతములు గాని లేవని ఒప్పుకొనుచు మాఇరుపార్టీల సమ్మతిని ఈ దత్తత స్వీకార దస్తావేజు వ్రాయించుకోవడమైనది\n',{align:'justify',lineGap:0})
//             pdfDocs.moveDown();
//             pdfDocs.fontSize('13').text(`1వపార్టీ:`,{align:'left',lineGap:0});
...
//                 pdfDocs.moveDown();
//             }
//             pdfDocs.fontSize('13').text(`2వపార్టీ:`,{align:'left',lineGap:0});
...
//             }else{
//                 pdfDocs.fontSize('13').text(`2. వ పార్టీ : .....................`,{align:'left',lineGap:0});
//                 pdfDocs.moveDown();
//             }
//             // pdfDocs.addPage();
...
const telGenarateDocs = async (data, path) => {
  try {
    let teluguHtmlFilePath = Path.join(__dirname, `../htmlFiles/30/telugu.hbs`);
