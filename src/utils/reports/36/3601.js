...
//                     })
//                     pdeStyle.content.push({
//                         text:'(Hereinafter called the PRINCIPAL which expression shall be deemed to include their heirs, successors, representatives and assignees.).',style:["p1Text"]
//                     })
//                 } else {
//                     pdeStyle.content.push({
...
//                     });
//                     pdeStyle.content.push({
//                         text:'(Hereinafter called the AGENT which expression shall be deemed to include their heirs, successors, representatives and assignees. ).',style:["p1Text"]
//                     })
//                 } else {
//                     pdeStyle.content.push({
//                         text: `M/s .${name}, ${address} is represented by`, style: ["p1Text"]
...
//         pdeStyle.content.push({
//             text:"BE IT KNOWN TO ALL CONCERNED THAT \n DETAILS OF DOCUMENT TO BE CANCELLED",style:["p1sideHeaders"]
//         })
...
//         let sNo = 1
//         let cvStaticArry = [];
//         covanantsData.CancellationOfGpa.map((cv) => {
...
//         pdeStyle.content.push({text:'\n AND WHEREAS for diverse causes and reasons the Principal deem it necessary to revoke the said Power..\n ',style:['p1Text']})
//         pdeStyle.content.push({
//             text:'\n KNOW YE ALL MEN BY THESE PRESENTS that I do hereby revoke, countermand, annul and make void all powers and authorities thereby and there under given to the said attorney vide the afore mentioned General Power of Attorney, expressly or impliedly, to all intents and purposes.',style:['p1Text']
//         })
//         pdeStyle.content.push({
//             Text:'\n Provided that the above revocation shall not render invalid or ineffective any act, deed, matter or things  lawfully and validly done by the said attorney  in exercise of any of such powers or authorities before the revocation thereof by these presents.',style:["p1Text"]
//         })
...
//         //         if (data?.claimant[i].partyType === "Public") {
//         //             pdeStyle.content.push({
//         //                 text: `\nSECOND PARTY : ${name}`, style: ["p1Text"]
//         //             })
//         //         } else {
//         //             pdeStyle.content.push({
//         //                 text: `\nSECOND PARTY : ${name}`, style: ["p1Text"]
...
//                 pdfDocs.fontSize(13).text('\n(అనువారు, వారి వారసులు, స్తానీయులు, రెప్రెసెంటేటివ్ లు, ఏజెంట్లు మరియు అసైనీలు “ప్రిన్సిపాల్స్  “ గా  ఈ దస్తావేజునందు పరిగణించబడుదురు).',{align:'justify',lineGap:0});
//                 pdfDocs.moveDown();
//                 }
//             }else{
...
//                 pdfDocs.fontSize('13').text('\n (అనువారు, వారి వారసులు, స్తానీయులు, రెప్రెసెంటేటివ్ లు, ఏజెంట్లు మరియు అసైనీలు “అటార్నీ “ గా ఈ దస్తావేజునందు పరిగణించబడుదురు).',{align:'justify',lineGap:0})
//                 pdfDocs.moveDown();
//                 }
//             }else{
//                 pdfDocs.fontSize('13').text(`శ్రీ/శ్రీమతి. .......,S/O. .........,వయస్సు ........ సంవత్సరాలు,ప్రస్తుతం......... లో నివాసము`,{align:'justify',lineGap:0});
...
//             pdfDocs.fontSize(13).text('\n ఇందుమూలముగా యావన్మందికి తెలియజేయునది ఏమనగా:   \n',{align:"justify",lineGap:1});
//             pdfDocs.fontSize(13).text('\n రద్దు చేయబడుచున్న దహస్తవేజు వివరాలు',{align:"justify",lineGap:0})
//             if(data.covanants?.acquireCovenents && data.covanants?.acquireCovenents.length >0){
//                 let aqCovanents=[]
...
//                 }
//             }
//             pdfDocs.fontSize(13).text('\n వివిధ కారణముల చేత ప్రిన్సిపాల్ పైన పేర్కొన్న జనరల్ పవరాఫ్ ఆటార్నీని రద్దు చేయుటకు నిర్ణయించుకోవడమైనది \n',{align:'justify',lineGap:0})
//             pdfDocs.fontSize(13).text('\n ఇందుములముగా యావన్మందికి తెలియజేయునది ఏమనగా పైన పేర్కొనిన జనరల్ పవరాఫ్ ఆటార్నీని ఈ వెంటనే రద్దు చేయుచు సదరు జనరల్ పవరాఫ్ ఆటార్నీ ద్వారా ఏజెంటుకు బదలాయించిన అన్ని అధికారములను ఈ రోజునుండి అమలులో లేకుండా చేయడమైనది.',{align:"justify",lineGap:0});
//             pdfDocs.fontSize(13).text('\n అయితే సదరు జనరల్ పవరాఫ్ ఆటార్నీమూలంగా ఏజంటు యిప్పటివరకు జరిపించిన అన్ని వ్యవహారములకు ఈ రద్దు దస్తావేజు వలన ఎటువంటి నష్టము వాటిల్లకుండుటకు నిర్ణయం. ',{align:"justify",lineGap:0});
//             pdfDocs.fontSize(13).text('\n ఈ క్రింది సాక్షుల సమక్షంలో పైన పేర్కొనిన తేదీన ఈ రద్దు దస్తావేజుపై సంతకములు చేయదమైనది.\n ',{align:"justify",lineGap:0})
//             pdfDocs.fontSize('13').text(`ప్రిన్సిపాల్  `,{align:'justify',lineGap:1});
//             if(data?.executent && data?.executent.length >0){
//                 let exNo =1
//                 for(let i of data.executent){
...
//             }else{
//                 pdfDocs.fontSize('13').text(`ప్రిన్సిపాల్ : .....................`,{align:'left',lineGap:0});
//                 pdfDocs.moveDown();
//             }
...
const telGenarateDocs = async (data, path) => {
  try {
    let teluguHtmlFilePath = Path.join(__dirname, `../htmlFiles/36/telugu.hbs`);
