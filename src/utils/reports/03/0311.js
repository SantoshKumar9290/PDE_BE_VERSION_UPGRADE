...
const engGenarateDocs = async (data, path) => {
  ...
  //     pdeStyle.content.push({text:`SETTLEMENT DEED OF TERRACE RIGHTS`.toUpperCase(),alignment: 'center',bold:true,decoration:'underline',margin:[10,y,0,0]});
  //     pdeStyle.content.push(' ');
  //     pdeStyle.content.push({text:`This SETTLEMENT DEED OF TERRACE RIGHTS DEED is made and executed on ${data.executionDate}, by :`, style:['p1sideHeaders']});
  ...
  //                 })
  //                 pdeStyle.content.push({
  //                     text:`\n(Hereinafter referred to as  ‘the SETTLOR’, unless repugnant to the context, mean and include her legal heirs, assigns, executors and administrators)`
  //                 })
  ...
  //         //     }
  //         // }
  //         pdeStyle.content.push({text:`\n NOW THIS DEED OF SETTLEMENT WITNESSES AS FOLLOWS  :`,style:['sideHeaderNames']})
  //         let sNo =1
  //         let cvStaticArry =[];
...
const telGenarateDocs = async (data, path) => {
  ...
  //         pdfDocs.fontSize('13').text(`\n సెటిలర్:`,{align:'left',lineGap:0,underline:true});
