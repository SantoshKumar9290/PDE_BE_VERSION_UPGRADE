...
const engGenarateDocs = async (data, path) => {
  ...
  //     pdeStyle.content.push({text:`GIFT DEED FOR CHARITABLE / RELIGIOUS PURPOSE`.toUpperCase(),alignment: 'center',bold:true,decoration:'underline',margin:[10,y,0,0]});
  //     pdeStyle.content.push(' ');
  //     pdeStyle.content.push({text:`This GIFT DEED FOR CHARITABLE / RELIGIOUS PURPOSE is made and executed on ${data.executionDate}, by :`, style:['p1sideHeaders']});
...
const telGenarateDocs = async (data, path) => {
  ...
  //         pdfDocs.fontSize('13').text(`1.	దాతలు  షెడ్యూలు ఆస్థిని మత పరమైన మరియు దాతృత్వ పరమైన కరణములచేత ప్రజోపయోగార్ధం ఉచితముగా యీ వెంటనే దాన స్వీకర్తకు స్వాదీన పర్చడమైనది. యింతటి నుండి సదరు ఆస్థిని దాన స్వీకర్త మునిసిపల్, యితర ప్రభుత్వ లెక్కలలో దాన స్వీకర్త పేరున నమోదు చేయించుకొని, సదరాస్థికి చెల్లించవలసిన పన్నులు వగైరాలు చెల్లించుకుంటూ ఋణ, దాన విక్రయాధికారపు సమస్త సంపూర్ణ హక్కులతోను, యీజిమెంటు రహదారి హక్కులతోను, దాన స్వీకర్త యిష్టానుసారం శాశ్వతముగా, స్వేచ్ఛగా, సుఖాన అనుభవించవలెను.  `,{align:'justify',lineGap:1});
