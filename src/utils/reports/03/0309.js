...
const engGenarateDocs = async (data, path) => {
  ...
  //     pdeStyle.content.push({text:`SETTLEMENT DEED IN FAVOUR OF GOVERNMENT`.toUpperCase(),alignment: 'center',bold:true,decoration:'underline',margin:[10,y,0,0]});
  //     pdeStyle.content.push(' ');
  //     pdeStyle.content.push({text:`This SETTLEMENT DEED IN FAVOUR OF GOVERNMENT is made and executed on this ${data.executionDate}, by :`, style:['p1sideHeaders']});
...
const telGenarateDocs = async (data, path) => {
  ...
  //         pdfDocs.fontSize('13').text(`సెటిలర్ ప్రజోపయోగర్ధం షెడ్యూలు ఆస్థిని ఉచితముగా యీ వెంటనే సెటిలీలకు స్వాధీన పర్చడమైనది. యింతటి నుండి  సదరు ఆస్థిని సెటిలీలు మునిసిపల్, యితర ప్రభుత్వ లెక్కలలో వారి పేరున నమోదు చేయించుకొని, సదరాస్థికి చెల్లించవలసిన పన్నులు వగైరాలు చెల్లించుకుంటూ ఋణ, దాన విక్రయాధికారపు సమస్త సంపూర్ణ హక్కులతోను, యీజిమెంటు రహదారి హక్కులతోను, సెటిలీల యిష్టానుసారం శాశ్వతముగా, స్వేచ్ఛగా, సుఖాన అనుభవించవలెను.`,{align:'justify',lineGap:1});
  ...
  //         pdfDocs.fontSize('13').text(`సెటిలర్:`,{align:'left',lineGap:0});
