...
const engGenarateDocs = async (data, path) => {
  ...
  //     pdeStyle.content.push({text:`GIFT DEED OF TERRACE RIGHTS`.toUpperCase(),alignment: 'center',bold:true,decoration:'underline',margin:[10,y,0,0]});
  //     pdeStyle.content.push(' ');
  //     pdeStyle.content.push({text:`This GIFT DEED OF TERRACE RIGHTS is made and executed on ${data.executionDate}, by :`, style:['p1sideHeaders']});
...
const telGenarateDocs = async (data, path) => {
  ...
  //         pdfDocs.fontSize('13').text(`దాన స్వీకర్తల యందు దాతలకు గల సహజ ప్రేమాభిమానముల చేతనూ, దాన స్వీకర్తలకు కొంత స్థిరోపాది   కలిపించే ఉద్దేశ్యము చేత, దాన స్వీకర్త దాత  పై ఆధారపడి యుండుట చేతనూ, ప్రేమయే ప్రతిఫలంగా యెంచి ఉచితముగా షెడ్యూలు ఆస్తి నందలి భవనము యొక్క టెర్రేస్ మీద భవన  నిర్మాణ హక్కులను యీ వెంటనే దఖలు పర్చి దాన స్వీకర్తకు స్వాధీన పర్చడమైనది. యింతటి నుండి సదరు ఆస్థిని దాన స్వీకర్త  మునిసిపల్, యితర ప్రభుత్వ లెక్కలలో దాన స్వీకర్త పేరున నమోదు చేయించుకొని, సదరాస్థికి చెల్లించవలసిన పన్నులు వగైరాలు చెల్లించుకుంటూ, పుత్ర, పౌత్ర వంశపారంపర్యంగా ఋణ, దాన విక్రయాధికారపు సమస్త సంపూర్ణ హక్కులతోను, యీజిమెంటు రహదారి హక్కులతోను, దాన స్వీకర్త యిష్టానుసారం శాశ్వతముగా, స్వేచ్ఛగా సుఖాన అనుభవించవలెను.`,{align:'justify',lineGap:1});
