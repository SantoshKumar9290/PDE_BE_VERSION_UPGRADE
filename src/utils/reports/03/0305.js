...
const engGenarateDocs = async (data, path) => {
  ...
  //     pdeStyle.content.push({text:`settlement deed in favour of local bodies`.toUpperCase(),alignment: 'center',bold:true,decoration:'underline',margin:[10,y,0,0]});
  //     pdeStyle.content.push(' ');
  //     pdeStyle.content.push({text:`This SETTLEMENT DEED IN FAVOUR OF LOCAL BODIES  is made and executed on this ${data.executionDate}, by :`, style:['p1sideHeaders']});
...
const telGenarateDocs = async (data, path) => {
  ...
  //         pdfDocs.fontSize('13').text(`సెటిలర్ లు:`,{align:'left',lineGap:0,underline:true});
