...
const engGenarateDocs = async (data, path) => {
  ...
  //     pdeStyle.content.push({text:`settlement deed for charitable / religious purpose`.toUpperCase(),alignment: 'center',bold:true,decoration:'underline',margin:[10,y,0,0]});
  //     pdeStyle.content.push(' ');
  //     pdeStyle.content.push({text:`This SETTLEMENT DEED FOR CHARITABLE / RELIGIOUS PURPOSE is made and executed on this ${data.executionDate}, by :`, style:['p1sideHeaders']});
