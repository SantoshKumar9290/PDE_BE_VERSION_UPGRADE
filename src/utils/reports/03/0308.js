...
const engGenarateDocs = async (data, path) => {
  ...
  //     pdeStyle.content.push({text:`GIFT DEED IN FAVOUR OF GOVERNMENT`.toUpperCase(),alignment: 'center',bold:true,decoration:'underline',margin:[10,y,0,0]});
  //     pdeStyle.content.push(' ');
  //     pdeStyle.content.push({text:`This GIFT DEED IN FAVOUR OF GOVERNMENT is made and executed on ${data.executionDate}, by :`, style:['p1sideHeaders']});
  ...
  //                 })
  //                 pdeStyle.content.push({
  //                     text:`\n(Hereinafter referred to as  ‘the DONOR’, unless repugnant to the context, mean and include her legal heirs, assigns, executors and administrators)`
  //                 })
