...
//         pdeStyle.content.push({
//             text:' All the contents of the will registered by me earlier along with the changes effected through this codicil shall come into force after my demise. ',style:["p1Text"]
//         });
//         pdeStyle.content.push({
//             text:'Having satisfied about the correctness of the contents of this codicil, I have executed this codicil in the presence of the following witnesses.',style:["p1Text"]
//         });
...
//                 pdfDocs.moveDown();
//                 }
//                 pdfDocs.fontSize('13').text(`నేను స్వస్ధ చిత్తముతోను, నిండు మనస్సుతోను, పూర్తి ఆరోగ్యం కలిగి సంపూర్ణ వ్యవహారిక జ్ఞానంతోను వ్రాయించి వుంచిన వీలునామా.`,{align:'left',lineGap:0})
...
//             pdfDocs.fontSize('13').text(`ఈ మార్పులు తప్ప నేను ఇంతకు పూర్వం వ్రాసిన వీలునామాలోని అంశములు యాధాతధముగా అమలు జరగవలెను. ఇది నా పూర్తి సమ్మతిన వ్రాసిన కొడిసిల్. లేఖరి చదవగా విన్నాను. సరిగ్గా యున్నoదున . క్రింది సాక్షుల ఎదుట సంతకములు చేయడమైనది. `,{align:'left',lineGap:0})
//             //property
