...
//             pdeStyle.content.push({
//                 text:`I have acquired the below mentioned movable and immovable properties. As I wish that there should not be any dispute among my family members in sharing the aforesaid properties after my demise, I make the following arrangements for my family members and other dependents`,style:["p1Text"]})
//         }else{
//             pdeStyle.content.push({
...
//         pdeStyle.content.push({
//             text:'All the contents of this will shall come into force only after my demise. I reserve the right to cancel or alter this will during my life time',style:["p1Text"]
//         });
//         pdeStyle.content.push({
//             text:'Having satisfied about the correctness of the contents of this will, I have executed this will in the presence of the following witnesses',style:["p1Text"]
//         });
...
//             pdfDocs.fontSize('13').text(`ఈ వీలునామా ${yyyy} వ సంవత్సరం ${mm} నెల ${dd} వతేదీన వ్రాయబడింది.`,{align:'center'});
...
//                 pdfDocs.moveDown();
//                 }
//                 pdfDocs.fontSize('13').text(`నేను స్వస్ధ చిత్తముతోను, నిండు మనస్సుతోను, పూర్తి ఆరోగ్యం కలిగి సంపూర్ణ వ్యవహారిక జ్ఞానంతోను వ్రాయించి ఇచ్చిన వీలునామా.`,{align:'left',lineGap:0})
...
//             pdfDocs.fontSize('13').text(`ఈ వీలునామా నా తదనంతరం అమలు జరుగవలెను.ఇది నాసమ్మతిన వ్రాయించిన  వీలునామా. ఈ వీలునామాలో చేసిన ఏర్పాట్లు గురించి ఉత్తరోత్తరా నా దాయాదులుగాని, ఇతరులు గాని, ఎట్టి అభ్యంతరములు గాని, ఆక్షేపణలు గాని, నిర్బంధములు గాని చేయరాదు. ఒక వేళ అట్టివి చేసిననూ అవి ఎంత మాత్రము చెల్లనేరవు. ఈవీలునామాలోని అంశములును నాజీవితకాలంలో మార్పులు,చేర్పులు చేసుకొనుటకు, రద్దుపరుచుకొనుటకు నాయందేపూర్తి అధికార మును ఉంచుకోవడ మైనది. లేఖరి చదవగా విన్నాను. సరిగ్గా యున్నoదున . క్రింది సాక్షుల ఎదుట సంతకములు చేయడమైనది.`,{align:'left',lineGap:0})
//             //property
