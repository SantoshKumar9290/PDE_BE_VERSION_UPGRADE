...
//                     })
//                     pdeStyle.content.push({
//                         text:'(hereinafter referred to as the First Party whereever it occurs).',style:["p1Text"]
//                     })
//                 } else {
//                     pdeStyle.content.push({
...
//                     });
//                     pdeStyle.content.push({
//                         text:'(hereinafter referred to as the Second Party whereever it occurs).',style:["p1Text"]
//                     })
//                 } else {
//                     pdeStyle.content.push({
//                         text: `M/s .${name}, ${address} is represented by`, style: ["p1Text"]
...
//         // pdeStyle.content.push({
//         //     text:"NOW THIS AGREEMENT WITNESSETH AS FOLLOWS:",style:["p1Text"]
//         // })
...
//         pdeStyle.content.push({
//             text:'\n This Divorce deed is executed voluntarily by both the parties and without any pressure or coercion.',style:["p1Text"]
//         })
//         pdeStyle.content.push({
//             text:'\n IN WITNESS WHERE OF both the parties have signed this deed of Divorce on the day mentioned above  in the presence of the following witnesses.',style:["p1Text"]
//         })
//         if (data?.executent && data?.executent.length > 0) {
//             for (var i = 0; i < data.executent.length; i++) {
//                 let name = data?.executent[i]?.name ? toTitleCase(data?.executent[i]?.name) : "............"
...
const telGenarateDocs = async (data, path) => {
  try {
    let teluguHtmlFilePath = Path.join(__dirname, `../htmlFiles/37/telugu.hbs`);
