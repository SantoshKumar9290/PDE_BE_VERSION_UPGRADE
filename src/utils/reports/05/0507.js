...
const engGenarateDocs = async (data, path) => {
  try {
    ...
    //     pdeStyle.content.push({text:`This DEED of ${subDesc.toUpperCase()} is made and executed on this ${dd} day of ${mm} , ${yyyy}, by :`, style:['p1sideHeaders']});
...
const telGenarateDocs = async (data, path) => {
  try {
    ...
    //     pdfDocs.fontSize('13').text(`సదరు షెడ్యూలు ఆస్థికి నీవు మేము తప్ప వేరెవ్వరు హక్కుదారులు లేరు. షెడ్యూలు ఆస్తిని మనము పంపకము జరిగించుకొని అనుభవించుటకు అవకాశము లేనందున షెడ్యూలు ఆస్తిలో మీతో పాటు నాకు/మాకు గల సమిష్టి వాటాను మేము వదులుకొనుటకు నిర్ణయించుకోవదమైనది. `,{align:'justify',lineGap:0});
    //     pdfDocs.fontSize('13').text(`పైన పొందుపరచిన ప్రతిఫలము మీరు  మాకు దస్తావేజు వ్రాత కాలమందు ఇచ్చినందున  అంధినవని ఒప్పుకొనుచు  షెడ్యూలు దాఖలా స్థిరాస్థి యందు రిలీజారుకు సంక్రమించిన జీవిత కాలపు అనుభవపు హక్కును యిందుమూలముగా రిలీజీకి వదులుకొని షెడ్యూలు దాఖలా ఆస్థిని రిలీజీకి ఈ వెంటనే స్వాధీనం చేయడమైనది`,{align:'justify',lineGap:0});
