...
const engGenarateDocs = async (data, path) => {
  try {
    ...
    //     pdeStyle.content.push({text:`This DEED OF ${subDesc.toUpperCase()} is made and executed on this ${dd} - ${mm} - ${yyyy}, by :`, style:['p1sideHeaders']});
    ...
    //     }
    //     // pdeStyle.content.push({
    //     //     text:`WHEREAS, the Releasee has obtained an amount of Rs._____________/- (Rupees ________________only) as loan from releaser and has created mortgage over the schedule property by way of mortgage deed registered as no.______/_______ at SRO ______________ . `,style:["p1Text"]
    //     // });
    //     // pdeStyle.content.push({
    ...
    //         // pdeStyle.content.push({
    //         //     text:`\n\nWhereas, the releasee has completely repaid the loan amount with interest and other expenses and requested the releasor to execute reconveyance deed. As there is no due from the release in respect of the aforementioned mortgage deed, this reconveyance deed is executed stating that the charge on the schedule mentioned property is cleared.`
    //         // })
    //         let sNo =1
    //         let cvStaticArry =[];
...
const telGenarateDocs = async (data, path) => {
  try {
    ...
    //         pdfDocs.moveDown();
    //         }
    //         pdfDocs.fontSize('13').text(`(అనువారు, వారి వారసులు, స్తానీయులు, రెప్రెసెంటేటివ్ లు, ఏజెంట్లు మరియు అసైనీలు “రిలీజరు “ గా ఈ దస్తావేజునందు పరిగణించబడుదురు).`,{align:'justify',lineGap:0});
    //         pdfDocs.moveDown()
    //     }else{
    ...
    //         pdfDocs.moveDown();
    //         }
    //         pdfDocs.fontSize('13').text(`(అనువారు, వారి వారసులు, స్తానీయులు, రెప్రెసెంటేటివ్ లు, ఏజెంట్లు మరియు అసైనీలు “రిలీజీ“ గా ఈ దస్తావేజునందు పరిగణించబడుదురు).`,{align:'justify',lineGap:0})
    //     }else{
    //         pdfDocs.fontSize('13').text(`శ్రీ/శ్రీమతి. .......,S/O. .........,వయస్సు ........ సంవత్సరాలు,ప్రస్తుతం......... లో నివాసము`,{align:'justify',lineGap:0});
    //         pdfDocs.moveDown();
    //         pdfDocs.fontSize('13').text(`(అనువారు, వారి వారసులు, స్తానీయులు, రెప్రెసెంటేటివ్ లు, ఏజెంట్లు మరియు అసైనీలు “రిలీజీ“ గా ఈ దస్తావేజునందు పరిగణించబడుదురు).`,{align:'justify',lineGap:0})
    ...
    //     pdfDocs.fontSize('13').text(`ఈ క్రింది షెడ్యూల్‌లో పేర్కొన్న ఆస్థిలో హక్కు గలదని రిలీజరు మరియు రిలీజీ లకు వివాదము కలదు. ఈ వివాదమును కొనసాగించుకొనుట మన ఇరువురికీ ఊపయోగకరము కాదని కొంత మొత్తమును ప్రతిఫలముగా తీసుకొని షెడ్యూలు ఆస్తిలో గల వివాదాస్పద హక్కును వదులు కోవలసినదిగా రిలీజీ కొరినందున అందులకు రిలీజరు అంగీకరించి ఈ షెడ్యూలు దాఖలా ఆస్థియందు రిలీజరుకు కలిగిన హక్కులు విడిచిపెట్టుకోవడమైనది. గాన యీ హక్కు విడుదల దస్తావేజును వ్రాయించి యిచ్చుటకు నిర్ణయించుకొని సదరు ప్రతిఫలం మొత్తమును దస్తావేజు వ్రాతకాలమందు చెల్లించినందున అందినవని ఒప్పుకొనుచు  షెడ్యూలు దాఖలా స్థిరాస్థి యందు రిలీజరుకు సంక్రమించిన హక్కును యిందుమూలముగా రిలీజీకి వదులుకొని షెడ్యూలు దాఖలా ఆస్థిని రిలీజీ కి ఈ వెంటనే స్వాధీనం చేయడమైనది. `,{align:'justify',lineGap:0});
    //     pdfDocs.fontSize('13').text(`కాబట్టి సదరాస్థి యందు యింతటినుండి రిలీజీ సమస్త, సంపూర్ణ హక్కులు పొంది ఋణ, దాన, విక్రయ సర్వాధికారములతో సుఖాన, స్వేచ్ఛగా అనుభవించుకోవలెను. సదరాస్థికి చెల్లించవలసిన పన్నులు వగైరాలు రిలీజీ చెల్లించుకుంటూ శ్రీ గవర్నమెంటు వారి రికార్డులలో రిలీజీ పేరున పట్టా నమోదు చేయించుకొని రిలీజీ ఇష్టానుసారం. మొత్తం ఆస్థిని ఋణ, దాన, విక్రయ సర్వాధికారములతో పుత్రపౌత్రవంశపారం పర్యాయం ఆచంద్రతారార్కం శాశ్వతంగా సుఖాన స్వేచ్ఛగా అనుభవించుకోవలెను. సదరు షెడ్యూలు దాఖలా ఆస్థిని గూర్చి వుత్తరోత్తర రిలీజీ పై గాని, వారి వారసులపై గాని, స్థానీయులపై గాని, రిలీజరు గాని, వారి వారసులు గాని యెన్నడూ యెట్టి తగాయిదాలు లాజుమాలు చేయగలవారు కారు. రిలీజరు తాలుకా హక్కును యిదివరలో ఏ అన్యాక్రాంతములు పరాదీనములు చేసియుండలేదని నమ్మించి ఈ వివాదపు హక్కు విడుదల దస్తావేజును వ్రాయించి యివ్వడమైనది.`,{align:'justify',lineGap:0});
    //     // pdfDocs.fontSize('13').text(`కాబట్టి సదరాస్థి యందు యింతటినుండి రిలీజీ సమస్త, సంపూర్ణ హక్కులు పొంది ఋణ, దాన, విక్రయ సర్వాధికారములతో స్వాతంత్య్రములతోనూ, సుఖాన, స్వేచ్ఛగా అనుభవించుకోవలెను. సదరాస్థికి చెల్లించవలసిన పన్నులు వగైరాలు రిలీజీ చెల్లించుకుంటూ శ్రీ గవర్నమెంటు వారి రికార్డులలో రిలీజీ పేరున పట్టా నమోదు చేయించుకొని రిలీజీ ఇష్టానుసారం. మొత్తం ఆస్థిని ఋణ, దాన, విక్రయ సర్వాధికారములతో పుత్రపౌత్రవంశపారం పర్యాయం ఆచంద్రతారార్కం శాశ్వతంగా సుఖాన స్వేచ్ఛగా అనుభవించుకోవలెను. సదరు షెడ్యూలు దాఖలా ఆస్థిని గూర్చి వుత్తరోత్తర రిలీజీ పై గాని, వారి వారసులపై గాని, స్థానీయులపై గాని, రిలీజరు గాని, వారి వారసులు గాని యెన్నడూ యెట్టి తగాయిదాలు లాజుమాలు చేయగలవారు కారు. రిలీజరు తాలుకా జీవిత కాలపు హక్కును యిదివరలో ఏ అన్యాక్రాంతములు పరాదీనములు చేసియుండలేదని నమ్మించి ఈ హక్కు విడుదల దస్తావేజును వ్రాయించి యివ్వడమైనది.`,{align:'left',lineGap:0});
    ...
    //     // pdfDocs.fontSize('13').text(`ఈ క్రింది షెడ్యూల్‌లో పేర్కొన్న ఆస్థిలో రిలీజర్ నకు  ____________సబ్ రిజిస్ట్రారు కార్యాలయం లో  _________/________ గా _____పుస్తకం నందు రిజిస్టరు చేయబడిన దస్తావేజు ద్వారా ________________ అను వారి నుండి జీవితకలము అనుభవించు హక్కు పొందియున్నారు. రిలీజరు తదనంతరం సదరు ఆస్థి పై రిలీజీకి పూర్తి హక్కులు చెందులాగున సదరు దస్తవేజుద్వార నిర్ణయించబడినది. కాగా రిలీజరు గల జీవితకలపు అనుభవించు హక్కును రూ॥___________/-లు (అక్షరములా ____________) తీసుకొని వదులు కోవలసినదిగా రిలీజీ కొరినందున అందులకు రిలీజరు పూర్తిగాఅంగీకరించి ఈ షెడ్యూలు దాఖలా ఆస్థియందు రిలీజరుకు కలిగిన అనుభవ హక్కులు విడిచిపెట్టుకోవడమైనది. గాన యీ హక్కు విడుదల దస్తావేజును వ్రాయించి యిచ్చుటకు నిర్ణయించుకొని సదరు ప్రతిఫలం రూ॥ __________/-లు (అక్షరములా ______________రూపాయలు) యీ దస్తావేజు వ్రాతకాలమందు చెల్లించినందున అంధినవని ఒప్పుకొనుచు  షెడ్యూలు దాఖలా స్థిరాస్థి యందు రిలీజారుకు సంక్రమించిన జీవిత కాలపు అనుభవపు హక్కును యిందుమూలముగా రిలీజీకి వదులుకొని షెడ్యూలు దాఖలా ఆస్థిని రిలీజీకి ఈ వెంటనే స్వాధీనం చేయడమైనది.`,{align:'left',lineGap:0})
    //     // pdfDocs.moveDown();
    //     // pdfDocs.fontSize('13').text(`కాబట్టి సదరాస్థి యందు యింతటినుండి రిలీజీ సమస్త, సంపూర్ణ హక్కులు పొంది ఋణ, దాన, విక్రయ సర్వాధికారములతో స్వాతంత్య్రములతోనూ, సుఖాన, స్వేచ్ఛగా అనుభవించుకోవలెను. సదరాస్థికి చెల్లించవలసిన పన్నులు వగైరాలు రిలీజీ చెల్లించుకుంటూ శ్రీ గవర్నమెంటు వారి రికార్డులలో రిలీజీ పేరున పట్టా నమోదు చేయించుకొని రిలీజీ ఇష్టానుసారం. మొత్తం ఆస్థిని ఋణ, దాన, విక్రయ సర్వాధికారములతో పుత్రపౌత్రవంశపారం పర్యాయం ఆచంద్రతారార్కం శాశ్వతంగా సుఖాన స్వేచ్ఛగా అనుభవించుకోవలెను. సదరు షెడ్యూలు దాఖలా ఆస్థిని గూర్చి వుత్తరోత్తర రిలీజీ పై గాని, వారి వారసులపై గాని, స్థానీయులపై గాని, రిలీజరు గాని, వారి వారసులు గాని యెన్నడూ యెట్టి తగాయిదాలు లాజుమాలు చేయగలవారు కారు. రిలీజరు తాలుకా జీవిత కాలపు హక్కును యిదివరలో ఏ అన్యాక్రాంతములు పరాదీనములు చేసియుండలేదని నమ్మించి ఈ హక్కు విడుదల దస్తావేజును వ్రాయించి యివ్వడమైనది.`,{align:'left',lineGap:0})
    //     // // pdfDocs.moveDown();
    ...
    //     pdfDocs.fontSize('13').text(`రిలీజరు`,{align:'left',lineGap:0,underline:true});
    //     if (data?.executent && data?.executent.length > 0) {
    //         let exNo = 1
    //         for (let i of data.executent) {
    //             let aadhar = i.aadhaar ? String(i.aadhaar).replace(String(i.aadhaar).substring(0, 8), "XXXX XXXX XXXX ") : "xxxx xxxx xxxx";
