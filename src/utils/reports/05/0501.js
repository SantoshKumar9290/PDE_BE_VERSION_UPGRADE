...
const engGenarateDocs = async (data, path) => {
  try {
    ...
    // pdeStyle.content.push({ text: `RELEASE DEED(CO-PARCENERS)`.toUpperCase(), alignment: 'center', bold: true, decoration: 'underline', margin: [10, y, 0, 0] });
    // pdeStyle.content.push(' ');
    // pdeStyle.content.push({ text: `This RELEASE DEED(CO-PARCENERS) is made and executed on this ${dd} - ${mm} - ${yyyy}, by :`, style: ['p1sideHeaders'] });
    ...
    //             })
    //             pdeStyle.content.push({ text: `(Hereinafter referred to as ‘the RELEASOR’, which expression shall, unless repugnant to the context, mean and includes his heirs, assigns, executors and administrators).`, style: ['p1Text_MR'] })
    //         } else {
    //             pdeStyle.content.push({
    ...
    //                 text: `\nMr/Mrs. ${name}, ${relationType} ${relationName} , aged about ${age}  years, Presently residing at ${toTitleCase(address)}`, style: ["p1Text"]
    //             });
    //             pdeStyle.content.push({ text: `(Hereinafter referred to as ‘the RELEASEE’, which expression shall, unless repugnant to the context, mean and includes his heirs, assigns, executors and administrators).`, style: ['p1Text_MR'] })
    //         } else {
    //             pdeStyle.content.push({
    //                 text: `M/s .${name}, ${address} is represented by`, style: ["p1Text"]
    //             })
    ...
    // pdeStyle.content.push({text:`And whereas the said property is not suitable for division and as the Releasor not interested to enjoy the undivided property, and releasor has agreed to release their share in favour of  the releasee. `, style: ["p1Text"]})

    // // pdeStyle.content.push({
    // //     text: `Whereas the schedule mentioned property has been acquired jointly by the Releasor and Releasee through a ___________ deed registered in their favour as No.________ /_______ at SRO __________ , Since then they are in peaceful possession and enjoyment.`, style: ["p1Text"]
    // // });
    // // pdeStyle.content.push({
    // //     text: `Releasor and Releasee are members of undivided family. Whereas the schedule mentioned property has been acquired jointly by the Releasor and Releasee through inheritance from their ancestors. Since then they are in peaceful possession and enjoyment.`, style: ["p1Text"]
    // // });
    // // pdeStyle.content.push({
    // //     text: `(Irrelevant para of the above two paras may be deleted).`, align: 'center', style: ["p1Text"]
    // // });
    // // pdeStyle.content.push({
    // //     text: `And whereas the said property is not suitable for division and as the Releasor not interested to enjoy the undivided property, and releasor has agreed to releasor their half undivided share for a valuable consideration of Rs._______________________/- (Rupees _______________________ Only) in favour of Releasee.`, style: ["p1Text"]
    // // });
    // if (TRAN_DESC) {
    ...
    //     pdeStyle.content.push({
    //         text:`NOW THIS DEED OF RELINQUISHMENT WITNESSETH AS FOLLOWS :`,bold:true,style:["p1Text"]
    //     });
    ...
    // ,style:'[p1Text_MR]'
    // })
    // pdeStyle.content.push({text:`In witness whereof the Releasor  have signed on this Release deed on the day, month & year mentioned above.\n`})
...
const telGenarateDocs = async (data, path) => {
  try {
    ...
    //                 pdfDocs.moveDown();
    //             }
    //             pdfDocs.fontSize('13').text(`(అనువారు, వారి వారసులు, స్తానీయులు, రెప్రెసెంటేటివ్ లు, ఏజెంట్లు మరియు అసైనీలు “రిలీసర్ “ గా ఈ దస్తావేజునందు పరిగణించబడుదురు).`, { align: 'justify', lineGap: 0 });
    //             pdfDocs.moveDown()
    //         } else {
    ...
    //         // pdfDocs.fontSize('13').text(`\n\nఈ క్రింది షెడ్యూల్‌లో పేర్కొన్న ఆస్థిని మనకు మన పూర్వీకుల ద్వారా సమిష్టిగా  సంక్రమించియున్నది. అప్పటి నుండి సదరు షెడ్యూలు ఆస్థి మన సంపూర్ణ స్వాధీన హక్కు అనుభవములలో వున్నది. సదరు షెడ్యూలు ఆస్థికి నీవు మేము తప్ప వేరెవ్వరు హక్కుదారులు లేరు. షెడ్యూలు ఆస్తిని మనము పంపకము జరిగించుకొని అనుభవించుటకు అవకాశము లేనందున షెడ్యూలు ఆస్తిలో మీతో పాటు నాకు/మాకు గల ____ వంతు సమిష్టి హక్కు వాటాను మేము వాదులుకొనుటకు నిర్ణయించుకొని నిన్ను కోరగా అందుకు నీవు/మీరు అంగీకరిస్తూ షెడ్యూలు ఆస్తి యందు నాకు/మాకు గల సమిష్టి వాటాకు  రూ._____________/- అక్షరములు రూపాయిలు ప్రతిఫలంగా ఇచ్చుటకు అంగీకరించినందున షెడ్యూలు ఆస్తిలో నాకు/మాకు గల హక్కులను వదులుకొనుటకు నిర్ణయించుకొని యీ హక్కు విడుదల దస్తావేజు మన ఇరుపార్టీల వారి సమ్మతిని వ్రాయించుకోవడమైనది. పైన అంగీకరించిన ప్రకారం మీరు నాకు/మాకు రూ. _______________ రూపాయిలు ప్రతిఫలంగా యీ దస్తావేజు వ్రాత కాలమందు ఇచ్చినందున ముట్టినది. కావున యింతటినుండి షెడ్యూల్ ఆస్తిని మీరు మీ యిస్టానుసరము వాడుక వగైరాలు జరిపించుకొని, సదరాస్థికి సంబంధించిన కార్యాలయపు రికార్డులలో మీ పేరును నమోదు చేయించుకొని అందుకు చెల్లగల పన్నులును మీరే చెల్లిచుకుంటూ,మీ పేరున రశీదులు పొందుతూ, మీరు మీ పుత్ర,పౌత్ర,వంశ పారం పర్యాయం, దాన, విక్రయ, సత్వాదీకర సమస్త హక్కులతో శాశ్వితము సుఖాన అనుభవించుకోవలెను. యిందుకు యిటుపైని మేము గాని, మా వారసులు గాని, మా స్థానీయులు గాని, మీపైన గాని, మీ వారసుల పైనిగాని,మీ స్థానీయుల పైన గాని ఏకాలానికి ఎట్టి తగాయిదాలు చేయవలసినవారము కాము అనిన్ని, మిమ్మును మేము నమ్మించి యీ హక్కు విడుదల దస్తావేజును మేము,మా మనస్ఫూర్తిగా  వ్రాయించి మీకు యివ్వడమైనది.\n`)
    ...
    //         pdfDocs.fontSize('13').text(`సదరు షెడ్యూలు ఆస్థికి నీవు మేము తప్ప వేరెవ్వరు హక్కుదారులు లేరు. షెడ్యూలు ఆస్తిని మనము పంపకము జరిగించుకొని అనుభవించుటకు అవకాశము లేనందున షెడ్యూలు ఆస్తిలో మీతో పాటు నాకు/మాకు గల సమిష్టి వాటాను మేము వదులుకొనుటకు నిర్ణయించుకోవదమైనది. \n`,{align:'justify',lineGap:0})

    //         pdfDocs.fontSize('13').text(`పైన పొందుపరచిన ప్రతిఫలము మీరు  మాకు దస్తావేజు వ్రాత కాలమందు ఇచ్చినందున ముట్టినది. కావున యింతటినుండి షెడ్యూల్ ఆస్తిని మీరు మీ యిస్టానుసరము వాడుక వగైరాలు జరిపించుకొని, సదరాస్థికి సంబంధించిన కార్యాలయపు రికార్డులలో మీ పేరును నమోదు చేయించుకొని అందుకు చెల్లగల పన్నులును మీరే చెల్లిచుకుంటూ,మీ పేరున రశీదులు పొందుతూ, మీరు మీ పుత్ర,పౌత్ర,వంశ పారం పర్యాయం, దాన, విక్రయ, సత్వాధికార సమస్త హక్కులతో శాశ్వితముగా సుఖాన అనుభవించుకోవలెను. యిందుకు యిటుపైని మేము గాని, మా వారసులు గాని, మా స్థానీయులు గాని, మీపైన గాని, మీ వారసుల పైనిగాని,మీ స్థానీయుల పైన గాని ఎట్టి తగాయిదాలు చేయగలవారము కాము అని, మిమ్మును మేము నమ్మించి యీ హక్కు విడుదల దస్తావేజును మేము,మా మనస్ఫూర్తిగా  వ్రాయించి మీకు యివ్వడమైనది.\n`,{align:'justify',lineGap:0})
    //         // let linkedText = "";
    //         // if (data.property && data.property.length > 0) {
    ...
    //         pdfDocs.fontSize('13').text(`\nఇందుకు సాక్షులు :`, { align: 'left', lineGap: 0, underline: true });
