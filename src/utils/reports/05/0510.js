...
const engGenarateDocs = async (data, path) => {
  try {
    ...
    //         // })
    //         pdeStyle.content.push({
    //             text:`NOW THIS DEED WITNESSES AS FOLLOWS:`,alignment: 'left',bold:true
    //         })
    //         let sNo =1
    //         let cvStaticArry =[];
...
const telGenarateDocs = async (data, path) => {
  try {
    ...
    //     pdfDocs.fontSize('13').text(`పైన పేర్కొనిన ప్రతిఫలము తీసుకొని వారికి గల జీవనభృతి హక్కులు వదులు కోవలసినదిగా రిలీజీ కొరినందున అందులకు రిలీజరు అంగీకరించి ఈ షెడ్యూలు దాఖలా ఆస్థియందు రిలీజారుకు కలిగిన మనోవర్తి హక్కులు విడిచిపెట్టుకోవడమైనది. గాన యీ హక్కు విడుదల దస్తావేజును వ్రాయించి యిచ్చుటకు నిర్ణయించుకొని సదరు ప్రతిఫలం యీ దస్తావేజు వ్రాతకాలమందు చెల్లించినందున అందినవని ఒప్పుకొనుచు  షెడ్యూలు దాఖలా స్థిరాస్థి యందు రిలీజరుకు సంక్రమించిన మనోవర్తి హక్కును యిందుమూలముగా రిలిజీకి వదులుకొని షెడ్యూలు దాఖలా ఆస్థిని రిలిజీకి ఈ వెంటనే స్వాధీనం చేయడమైనది.`,{align:'justify',lineGap:0});
    //     pdfDocs.fontSize('13').text(`కాబట్టి సదరాస్థి యందు యింతటినుండి రిలీజీ సమస్త, సంపూర్ణ హక్కులు పొంది ఋణ, దాన, విక్రయ సర్వాధికారములతో స్వాతంత్య్రములతోనూ, సుఖాన, స్వేచ్ఛగా అనుభవించుకోవలెను. సదరాస్థికి చెల్లించవలసిన పన్నులు వగైరాలు రిలీజీ చెల్లించుకుంటూ శ్రీ గవర్నమెంటు వారి రికార్డులలో రిలీజీ పేరున పట్టా నమోదు చేయించుకొని రిలీజీ ఇష్టానుసారం. మొత్తం ఆస్థిని ఋణ, దాన, విక్రయ సర్వాధికారములతో పుత్రపౌత్రవంశపారం పర్యాయం ఆచంద్రతారార్కం శాశ్వతంగా సుఖాన స్వేచ్ఛగా అనుభవించుకోవలెను. సదరు షెడ్యూలు దాఖలా ఆస్థిని గూర్చి వుత్తరోత్తర రిలీజీ పై గాని, వారి వారసులపై గాని, స్థానీయులపై గాని, రిలీజరు గాని, వారి వారసులు గాని యెన్నడూ యెట్టి తగాయిదాలు లాజుమాలు చేయగలవారు కారు. రిలీజరు తాలుకా జీవనభృతి హక్కును యిదివరలో ఏ అన్యాక్రాంతములు పరాదీనములు చేసియుండలేదని నమ్మించి ఈ హక్కు విడుదల దస్తావేజును వ్రాయించి యివ్వడమైనది.`,{align:'justify',lineGap:0});
